// TECHDEBT: this widget is almost the same as the testStoreSettingWidget.js. The only thing that differs is the settings selector on line 16.
//           Is there a way to get rid of this code duplication?

angular.module('virtoCommerce.avataxModule')
.controller('virtoCommerce.avataxModule.testPlatformSettingsWidgetController', ['$scope', 'platformWebApp.bladeNavigationService', 'virtoCommerce.avataxModule.resources', function ($scope, bladeNavigationService, avataxModuleResources) {
    ...
    $scope.testConnection = function () {
        ...
        var connectionInfo = createAvaTaxConnectionInfo($scope.blade.currentEntities['Avalara']);
